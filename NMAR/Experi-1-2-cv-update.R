#### 5.1 Situation 2 (Construction of CV)
...
for(iteite in 1:ite){
  ...
  sigmoid <- function(xxx,yyy){
    return(1.0/(1.0+exp(-beta-beta2*xxx-beta3*(xxx*xxx)-gamma*yyy)))
  }
...
print(mean((gamma_estimate2[gamma_estimate2<1.8]-true_gamma)*(gamma_estimate2[gamma_estimate2<1.8]-true_gamma)))
