...
boxplot(ccc$x ~ factor(ccc$z,levels=c('IPW',"MP","DR")) + factor(ccc$y,levels=c("GMM","SCORE","CA1","CA2_A")) ,las = 2,at=c(1:3,5:7,9:11,13:15),main="1_1 MU",las = 2)
...
boxplot(ccc,las = 2,main="1_1 GAMMA")
abline(h=0.6)